...
## Review
- [x] Resolved prior finding: `tests/fixtures/dotnet/basic-fail/native-summary.json` is now tracked in the branch, so rerunning the documented fixture regeneration no longer leaves that generated artifact untracked.
