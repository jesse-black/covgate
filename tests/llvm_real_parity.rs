...
mod tests {
    ...
    fn real_multi_file_llvm_export_markdown_totals_match_covgate_calculations() {
        ...
        let covgate_region = parse_markdown_totals(&markdown, "Region")
            .expect("markdown region totals should exist");
        let covgate_line =
    ...
    fn real_multi_file_llvm_export_documents_summary_semantics_disagreement() {
        ...
        let native_region =
            llvm_totals(&native_json, "regions").expect("region totals should exist");
